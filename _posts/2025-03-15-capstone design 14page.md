...
이 문서에서는 주사위 3개를 사용해 세 자리 숫자를 만드는 게임에서,  
고정 전략과 남은 두 주사위의 최적 배치를 고려한 모든 216가지 경우의  
최종 세 자리 수를 직접 계산하여 이론적 기댓값이 **504**임을 보입니다.
